...
class DetectModel():
    ...
    def setupModel(self):
        ...
        ToolUtil.print_info('Added CONV-BLOCK-1+SIDE-1')
        ...
        ToolUtil.print_info('Added CONV-BLOCK-2+SIDE-2')
        ...
        ToolUtil.print_info('Added CONV-BLOCK-3+SIDE-3')
        ...
        ToolUtil.print_info('Added CONV-BLOCK-4+SIDE-4')
        ...
        ToolUtil.print_info('Added CONV-BLOCK-5+SIDE-5')
        ...
        ToolUtil.print_info('Added FUSE layer')

        # complete output maps from side layer and fuse layers
        self.outputs = self.side_outputs + [self.fuse]

        self.data_dict = None
        ToolUtil.print_info("Build model finished: {:.4f}s".format(time.time() - start_time))
    ...
    def setup_training(self, session):
        ...
        ToolUtil.print_warning('Deep supervision application set to {}'.format(self.cfgs['deep_supervision']))
